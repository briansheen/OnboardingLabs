...
public class TwitterService {
    ...
    public TwitterPost postTweet(String message, TwitterAppConfigurationKeys keys) {
        ...
        try {
            ...
            return new TwitterPost(new TwitterUser(status.getUser().getScreenName(), status.getUser().getName(), status.getUser().getProfileImageURL()), status.getText(), status.getCreatedAt());
